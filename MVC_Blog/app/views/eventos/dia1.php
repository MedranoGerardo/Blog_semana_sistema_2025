...
<body>
    <div class="container">
        ...
        <section class="event-content">
            ...
            <div class="event-description">
                <p>
                    ...
                    donde autoridades universitarias y representante estudiantil de la ASEIS dio
            ...
            <div class="gallery">
                ...
                <div class="gallery-grid">
                    <div class="gallery-item">
                        <img src="https://res.cloudinary.com/djkezou6s/image/upload/v1760665103/img1_bremx5.jpg" alt="Inauguración">
                        <p class="gallery-caption">Ceremonia de inauguración</p>
                    </div>

                    <div class="gallery-item">
                        <img src="https://res.cloudinary.com/djkezou6s/image/upload/v1760665103/img2_ppjpmq.jpg" alt="esperando">
                        <p class="gallery-caption">Esperando a que inicie el evento</p>
                    </div>

                    <div class="gallery-item">
                        <img src="https://res.cloudinary.com/djkezou6s/image/upload/v1760665103/img3_cr3k8b.jpg" alt="palabras de la vicedecana">
                        <p class="gallery-caption">Palabras de la vicedecana</p>
                    </div>

                    <div class="gallery-item">
                        <img src="https://res.cloudinary.com/djkezou6s/image/upload/v1760665103/img4_mmcyni.jpg" alt="Ponencia">
                        <p class="gallery-caption">Primera ponencia del día</p>
                    </div>

                    <div class="gallery-item">
                        <img src="https://res.cloudinary.com/djkezou6s/image/upload/v1760665104/img5_o3gasy.jpg" alt="reconocimiento">
                        <p class="gallery-caption">Reconocimiento del Msc. Luis Contreras</p>
                    </div>

                    <div class="gallery-item">
                        <img src="https://res.cloudinary.com/djkezou6s/image/upload/v1760665103/img6_tczste.jpg" alt="Ponencia2">
                        <p class="gallery-caption">Segunda ponencia del día</p>
                    </div>
                </div>
            </div>
            ...
            <div class="videos">
                ...
                <div class="video-container" >
                    <video controls poster="https://res.cloudinary.com/djkezou6s/video/upload/v1760667276/ponencia2_vgk485.mp4">
                    <source src="https://res.cloudinary.com/djkezou6s/video/upload/v1760667276/ponencia2_vgk485.mp4" type="video/mp4">
                    Tu navegador no soporta el elemento de video.
                    </video>
                    <p class="video-caption">Video resumen de la ponencia 2 del día 1</p>
                </div>
            </div>
            ...
            <div class="attendance-proof">
                ...
                <p>
                    ...
                    hasta el hackathon de C#.
                </p>
                <div class="proof-images">
                    <img src="https://res.cloudinary.com/djkezou6s/image/upload/v1760665103/img_hognms.jpg" alt="Mi asistencia 1">
                    <img src="https://res.cloudinary.com/djkezou6s/image/upload/v1760665103/img8_bv1ki5.jpg" alt="Mi asistencia 2">
                </div>
            </div>
        </section>
        ...
        <nav class="day-navigation">
            ...
            <a href="<?php echo url('evento/dia2'); ?>" class="btn">Día 2 - Talleres →</a>
        </nav>
    </div>
</body>
